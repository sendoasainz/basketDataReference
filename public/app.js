...
function getTeamFullName(abbrev, database, leagueSlug) {
  ...
  const leagueStaticMaps = {
    ...
    'betclic-elite': {
      ...
      'SQB': 'Saint-Quentin',
      'BOU': 'Bouzalac', 'BLO': 'Bouzalac',
      'JSF': 'Nanterre 92', 'NAN': 'Nanterre 92',
      'CHO': 'Cholet Basket', 'CB': 'Cholet Basket',
      'SIG': 'SIG Strasbourg', 'STR': 'SIG Strasbourg',
      'SLUC': 'SLUC Nancy',
      'ESSM': 'ESSM Le Portel', 'POR': 'ESSM Le Portel', 'LEP': 'ESSM Le Portel',
    ...
    'easycredit-bbl': {
      ...
      'ALB': 'Alba Berlin',
      'ULM': 'ratiopharm ulm', 'RAT': 'ratiopharm ulm',
